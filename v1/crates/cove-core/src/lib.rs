//! # cove-core — Cove Format (COVE) v1.0 reference library
//!
//! This crate provides the foundational building blocks for reading and writing
//! Cove Format (COVE) v1.0 files as defined in the [COVE specification].
//!
//! ## Modules
//!
//! | Module | Contents |
...
//! | [`header`] | [`header::CoveHeaderV1`] — the 128-byte file header (Section 10). |
