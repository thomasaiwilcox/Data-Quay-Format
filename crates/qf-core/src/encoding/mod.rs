//! Quay Format (QF) v1.0 — Encoding cascades (Spec §20.3).
//!
...
//! [`crate::constants::QfEncodingKind`].
...
/// Common contract for every QF v1 cascade (Spec §20.3, §21).
pub trait Encoding {
...
pub fn assert_parity<E: Encoding>(payload: &E::Payload) -> Result<(), QfError> {
