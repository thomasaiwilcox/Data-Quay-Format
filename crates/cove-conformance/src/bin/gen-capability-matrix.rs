...
fn rows() -> Vec<Row> {
    vec![
        ...
        Row {
            ...
            written: "helper",
            corpus: "yes",
            notes: "domain.rs; accept/reject corpus plus cove-validate negative integration",
        },
        Row {
            section: "§24",
        ...
        Row {
            ...
            written: "helper",
            corpus: "yes",
            notes: "profile/cove_e.rs; descriptor/registry/policy plus required/optional corpus",
        },
        Row {
            section: "§44",
            ...
            written: "helper",
            corpus: "yes",
            notes: "profile/cove_h.rs; mount-hints plus required/optional corpus",
        },
        Row {
            section: "§49",
        ...
        Row {
            ...
            written: "helper",
            corpus: "yes",
            notes: "profile/cove_o.rs; accept/reject catalog plus required/optional corpus",
        },
        Row {
            section: "§57",
            ...
            written: "helper",
            corpus: "yes",
            notes: "profile/cove_o.rs; accept/reject temporal-index corpus",
        },
        Row {
            section: "§58",
            ...
            written: "n/a",
            corpus: "no",
            notes: "profile/cove_o.rs helper; temporal data parser pending",
        },
        Row {
            section: "§60",
            ...
            written: "n/a",
            corpus: "no",
            notes: "profile/cove_o.rs helper; prev_ref wire integration pending",
        },
        Row {
            section: "§63",
        ...
        Row {
            ...
            written: "helper",
            corpus: "yes",
            notes: "artifact/covx.rs; accept/reject artifact corpus",
        },
        Row {
            section: "§69",
            ...
            written: "helper",
            corpus: "yes",
            notes: "artifact/covm.rs; accept/reject manifest corpus",
        },
        Row {
            section: "§71",
            ...
            written: "partial",
            corpus: "partial",
            notes: "Minimal writer plus ScanProfileCoveWriter; generated COVE-T fixture; page payload writer pending",
        },
        Row {
            section: "§72",
            ...
            written: "n/a",
            corpus: "yes",
            notes: "reader stages + cove-validate; required/optional profile corpus; COVE-O temporal data invariants pending",
        },
        Row {
            section: "§74",
        ...
        Row {
            ...
            written: "partial",
            corpus: "partial",
            notes: "78-fixture cove-conformance corpus, cove-bench smoke, and deterministic robustness harness",
        },
    ]
}
