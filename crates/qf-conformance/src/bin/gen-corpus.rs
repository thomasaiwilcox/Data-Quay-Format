...
//! Run with `cargo run -p qf-conformance --bin gen-corpus`.
//!
...
use qf_core::{
    artifact::{
        qfm::{QfmFile, QfmFileEntryV1, QfmHeaderV1, QfmPostscriptV1},
        qfx::{QfxFile, QfxHeaderV1, QfxPostscriptV1, QfxReferencedFileV1},
    },
    checksum,
    constants::{
        DigestAlgorithm, PrimaryProfile, QfEncodingKind, QfLogicalType, QfPhysicalKind,
    ...
    postscript::{QfPostscriptV1, POSTSCRIPT_SIZE, POSTSCRIPT_TOTAL_SIZE},
    profile::{
        qfe::{
...
fn main() {
    ...
    // accept/min_empty: structurally valid empty QF-T file.
    let bytes = MinimalQfWriter::write_empty_file();
    write_fixture(
        &root,
        &mut entries,
        fixture(
            "accept/min_empty.quay",
            "qf",
            "accept",
            None,
            &["§9", "§10", "§13", "§71.1"],
    ...
    let qfx_bytes = valid_qfx_file();
    write_fixture(
        &root,
        &mut entries,
        fixture("accept/qfx_valid.qfx", "qfx", "accept", None, &["§68"]),
        qfx_bytes.clone(),
    );

    let qfm_bytes = valid_qfm_file();
    write_fixture(
        &root,
        &mut entries,
        fixture("accept/qfm_valid.qfm", "qfm", "accept", None, &["§69"]),
        qfm_bytes.clone(),
    );
    ...
    write_fixture(
        ...
        br#"{"producer":"qf-conformance","purpose":"metadata fixture"}"#.to_vec(),
    );
    ...
    write_fixture(
        ...
        page_index_payload(4, 1, QfEncodingKind::PlainFixed as u16),
    );
    ...
    write_fixture(
        ...
        lakehouse_hints_payload("catalog://qf", "generated"),
    );
    ...
    write_fixture(
        ...
        kernel_capabilities_payload(QfEncodingKind::Rle as u16),
    );
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "accept/qfe_engine_registry_valid.bin",
            "qfe_engine_registry",
            "accept",
            None,
            &["§39"],
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "accept/qfe_execution_code_valid.bin",
            "qfe_execution_code",
            "accept",
            None,
            &["§40"],
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "accept/qfe_mount_policy_valid.bin",
            "qfe_mount_policy",
            "accept",
            None,
            &["§43"],
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "accept/qfh_mount_hints_valid.bin",
            "qfh_mount_hints",
            "accept",
            None,
            &["§44"],
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "accept/qfo_object_catalog_valid.bin",
            "qfo_object_catalog",
            "accept",
            None,
            &["§56"],
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "accept/qfo_temporal_segment_index_valid.bin",
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "accept/qf_unknown_optional_feature.quay",
            "qf",
            "accept",
            None,
            &["§76"],
        ),
        qf_with_unknown_optional_feature(),
    );
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "accept/qfe_optional_bad_descriptor.quay",
            "qf",
            "accept",
            None,
            &["§40", "§76"],
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "accept/qfh_optional_bad_hints.quay",
            "qf",
            "accept",
            None,
            &["§44", "§76"],
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "accept/qfo_optional_bad_catalog.quay",
            "qf",
            "accept",
            None,
            &["§56", "§76"],
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "reject/header_magic_swapped.quay",
            "qf",
            "reject",
            Some("QF_E_CHECKSUM_MISMATCH"),
            &["§9", "§75"],
        ),
        hdr_bad,
    );
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "reject/footer_crc_flipped.quay",
            "qf",
            "reject",
            Some("QF_E_CHECKSUM_MISMATCH"),
            &["§13", "§75"],
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "reject/qft_bad_column_domain.quay",
            "qf",
            "reject",
            Some("QF_E_BAD_DOMAIN"),
            &["§23", "§72", "§75"],
        ),
        qf_file_with_section(
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "reject/qft_duplicate_table_id.quay",
            "qf",
            "reject",
            Some("QF_E_BAD_SCHEMA"),
            &["§24", "§72", "§75"],
        ),
        qf_file_with_section(
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "reject/qft_bad_segment_gap.quay",
            "qf",
            "reject",
            Some("QF_E_SEGMENT_CORRUPT"),
            &["§25", "§72", "§75"],
        ),
        qf_file_with_section(
            FEATURE_TABLE_PROFILE,
    ...
    write_fixture(
        ...
        fixture(
            ...
            "table_catalog",
            "reject",
            Some("QF_E_BAD_LOGICAL_PHYSICAL_PAIR"),
            &["§24", "§75"],
        ),
    ...
    let mut qfx_bad = qfx_bytes;
    qfx_bad[82] ^= 0xFF;
    write_fixture(
        &root,
        &mut entries,
        fixture(
            "reject/qfx_header_crc_flipped.qfx",
            "qfx",
            "reject",
            Some("QF_E_CHECKSUM_MISMATCH"),
            &["§68", "§75"],
    ...
    let mut qfm_bad = qfm_bytes;
    qfm_bad[78] ^= 0xFF;
    write_fixture(
        &root,
        &mut entries,
        fixture(
            "reject/qfm_header_crc_flipped.qfm",
            "qfm",
            "reject",
            Some("QF_E_CHECKSUM_MISMATCH"),
            &["§69", "§75"],
    ...
    write_fixture(
        ...
        fixture(
            ...
            "page_index",
            "reject",
            Some("QF_E_PAGE_CORRUPT"),
            &["§27", "§75"],
        ),
        page_index_payload(4, 5, QfEncodingKind::PlainFixed as u16),
    );
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "reject/qfe_engine_registry_duplicate_namespace.bin",
            "qfe_engine_registry",
            "reject",
            Some("QF_E_BAD_ENGINE_PROFILE"),
            &["§39", "§75"],
        ),
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "reject/qfe_execution_code_bad_kind.bin",
            "qfe_execution_code",
            "reject",
            Some("QF_E_BAD_ENGINE_PROFILE"),
            &["§40", "§75"],
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "reject/qfe_mount_policy_bad_mapping.bin",
            "qfe_mount_policy",
            "reject",
            Some("QF_E_BAD_ENGINE_PROFILE"),
            &["§43", "§75"],
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "reject/qfh_mount_hints_reserved.bin",
            "qfh_mount_hints",
            "reject",
            Some("QF_E_BAD_SECTION"),
            &["§44", "§75"],
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "reject/qfo_object_catalog_duplicate_property.bin",
            "qfo_object_catalog",
            "reject",
            Some("QF_E_BAD_SCHEMA"),
            &["§56", "§75"],
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "reject/qfo_temporal_segment_index_bad_counts.bin",
            "qfo_temporal_segment_index",
            "reject",
            Some("QF_E_BAD_SCHEMA"),
            &["§57", "§75"],
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "reject/qf_unknown_required_feature.quay",
            "qf",
            "reject",
            Some("QF_E_UNKNOWN_REQUIRED_FEATURE"),
            &["§76", "§75"],
        ),
        qf_with_unknown_required_feature(),
    );
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "reject/qfe_required_bad_descriptor.quay",
            "qf",
            "reject",
            Some("QF_E_BAD_ENGINE_PROFILE"),
            &["§40", "§76", "§75"],
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "reject/qfh_required_bad_hints.quay",
            "qf",
            "reject",
            Some("QF_E_BAD_SECTION"),
            &["§44", "§76", "§75"],
    ...
    write_fixture(
        ...
        &mut entries,
        fixture(
            "reject/qfo_required_bad_catalog.quay",
            "qf",
            "reject",
            Some("QF_E_BAD_SCHEMA"),
            &["§56", "§76", "§75"],
    ...
    if check_mode() {
        ...
        assert_eq!(
            ...
            "{} is not up to date; run cargo run -p qf-conformance --bin gen-corpus",
            manifest.display()
        );
        println!(
...
fn qf_with_unknown_optional_feature() -> Vec<u8> {
    let mut writer = MinimalQfWriter::new();
    writer.optional_features = 1u64 << 63;
    writer.write()
}

fn qf_with_unknown_required_feature() -> Vec<u8> {
    let writer = MinimalQfWriter::new();
    let mut bytes = writer.write();
    rewrite_qf_feature_bits(&mut bytes, FEATURE_TABLE_PROFILE | (1u64 << 63), 0);
    bytes
}

fn rewrite_qf_feature_bits(bytes: &mut [u8], required_features: u64, optional_features: u64) {
...
fn engine_registry_payload(namespaces: &[&str]) -> Result<Vec<u8>, qf_core::QfError> {
...
fn qft_scan_table_file() -> Vec<u8> {
    let mut writer = ScanProfileQfWriter::new(valid_table_catalog());
...
fn bad_pair_table_catalog() -> TableCatalog {
    let mut catalog = valid_table_catalog();
    catalog.tables[0].columns[0].physical = QfPhysicalKind::VarBytes;
    catalog
}

fn valid_column_domain_payload() -> Vec<u8> {
    ColumnDomain::from_sorted_present_codes(&[1, 3], 4, 1, 1, QfLogicalType::Utf8 as u16, 0, 0)
        .unwrap()
        .serialize()
        .unwrap()
}
...
fn invalid_column_domain_payload() -> Vec<u8> {
    ColumnDomain {
        header: ColumnDomainHeaderV1 {
            ...
            logical_type: QfLogicalType::Utf8 as u16,
            collation_id: 0,
            domain_count: 2,
...
fn valid_qfx_file() -> Vec<u8> {
    QfxFile {
        header: QfxHeaderV1::new([0x11; 16], 0, 1_700_000_000_000_000),
        referenced_files: vec![QfxReferencedFileV1 {
            file_id: [0x22; 16],
            file_len: 244,
...
fn valid_qfm_file() -> Vec<u8> {
    QfmFile {
        header: QfmHeaderV1::new([0x55; 16], 1, 0, 1_700_000_000_000_000),
        files: vec![QfmFileEntryV1 {
            file_id: [0x66; 16],
            uri: "file:///dataset/part-0.quay".into(),
            file_len: 244,
            footer_crc32c: checksum::crc32c(b"footer"),
            digest_algorithm: 1,
            digest: vec![0x77; 32],
